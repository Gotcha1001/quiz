    ...
    <div className="flex flex-col gap-4">
      <div className="h-[15rem] px-8 flex items-center justify-center border-2 rounded-xl shadow-[0_.3rem_0_0_rgba(0,0,0,0.1)]">
        <Image
          ...
          width={200}
          height={200}
          className="rounded-full border-2 shadow-[0_.3rem_0_0_rgba(0,0,0,0.2)]"
        />
      </div>
      <div className="mt-4">
      ...
      <div className="grid grid-cols-3 gap-6 font-semibold">
        <div className="py-4 px-4 flex flex-col gap-1 border-2 rounded-lg shadow-[0_.3rem_0_0_rgba(0,0,0,0.2)]">
          <h2 className="font-bold text-xl">{user?.firstName}</h2>
          <p className="text-blue-400 font-semibold">Recent Attempt</p>
      ...
      <div className="border-2 rounded-lg shadow-[0_.3rem_0_0_rgba(0,0,0,0.2)]">
        <Table>
